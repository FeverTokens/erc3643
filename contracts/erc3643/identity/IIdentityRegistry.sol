...
interface IIdentityRegistry is IIdentityRegistryInternal {
     ...
     * @param _identity The identity contract address for the user
     ...
     * @return address The identity contract address, or zero address if not registered
     */
     ...
     * @param _userAddress The wallet address to query
     * @return address The stored identity contract address
     */
     ...
     * @param _userAddress The wallet address to query
     * @return uint16 The stored country code
     */
