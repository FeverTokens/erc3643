...
interface ITrustedIssuersRegistryInternal {
     ...
     * @param trustedIssuer The issuer contract that was added as trusted
     ...
     * @param trustedIssuer The issuer contract that was removed as trusted
     */
    event TrustedIssuerRemoved(IClaimIssuer indexed trustedIssuer);

    /**
     * @notice Emitted when claim topics are updated for a trusted issuer
     * @param trustedIssuer The issuer contract whose claim topics were updated
