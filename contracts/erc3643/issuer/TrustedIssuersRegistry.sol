...
contract TrustedIssuersRegistry is ITrustedIssuersRegistry, TrustedIssuersRegistryInternal {
    
    // Setters
    function addTrustedIssuer(address _trustedIssuer, uint256[] calldata _claimTopics) external override {
        _addTrustedIssuer(_trustedIssuer, _claimTopics);
    }
    
    function removeTrustedIssuer(address _trustedIssuer) external override {
